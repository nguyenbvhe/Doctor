...
class IntroViewController: UIViewController {
    ...
    let introData: [IntroLogin] = [
        ...
        IntroLogin(image: "img_intro_2", title: "Bác sĩ sẵn lòng chăm sóc khi bạn cần", subTitle: "Chọn chuyên khoa, bác sĩ phù hợp và được thăm khám trong không gian thoải mái tại nhà")
        ]
